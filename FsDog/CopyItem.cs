  ...
  public class CopyItem : INotifyPropertyChanged
  {
    ...
    public Image Info
    {
      get
      {
        ...
        if (BaseHelper.InList((object) this.ErrorHandling, (object) CopyErrorHandling.Handle, (object) CopyErrorHandling.Skip))
          return CopyItem._emptyImage;
    ...
    {
      [DebuggerNonUserCode] get => this.SourceFile != null ? string.Format("{0}\r\n{1}", (object) this.SourceFile.FullName, (object) this.DestinationFile.FullName) : string.Format("{0}\r\n{1}", (object) this.SourceDirectory.FullName, (object) this.DestinationDirectory.FullName);
    }

    [Browsable(false)]
    public FileInfo DestinationFile
    {
      [DebuggerNonUserCode] get => this._destinationFile;
    }

    [Browsable(false)]
    public DirectoryInfo DestinationDirectory
    {
      [DebuggerNonUserCode] get => this._destinationDirectory;
    }

    [Browsable(false)]
    public FileInfo SourceFile
    {
      [DebuggerNonUserCode] get => this._sourceFile;
    }

    [Browsable(false)]
    public DirectoryInfo SourceDirectory
    {
      [DebuggerNonUserCode] get => this._sourceDirectory;
    }
    ...
    {
      [DebuggerNonUserCode] get => this._errorType;
    }
    ...
    {
      [DebuggerNonUserCode] get => this.GetErrorText();
    }

    [Browsable(false)]
    public CopyErrorHandling ErrorHandling
    {
      [DebuggerNonUserCode] get => this._errorHandling;
    ...
    {
      [DebuggerNonUserCode] add => this.PropertyChanged += value;
      [DebuggerNonUserCode] remove => this.PropertyChanged -= value;
    }
  }
}
