...
// Type: FR.Data.SqlClient.Smo.SmoStatisticCollection
...
{
  public class SmoStatisticCollection : SmoCollection<SmoStatistic>
  {
    internal SmoStatisticCollection(SmoTable table)
      : base((SmoObject) table)
    {
    }

    internal SmoStatisticCollection(SmoView view)
      : base((SmoObject) view)
    {
    }
  }
