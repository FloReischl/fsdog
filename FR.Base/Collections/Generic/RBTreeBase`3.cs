...
namespace FR.Collections.Generic
{
    ...
    where TNode : RBTreeBase<TKey, TValue, TNode>.RBNodeBase
  {
    ...
    {
      [DebuggerNonUserCode] get => this._allowNestedIndexes;
      [DebuggerNonUserCode] set => this._allowNestedIndexes = value;
    }

    public int Count
    {
      [DebuggerNonUserCode] get => (object) this._root != null ? this._root.BranchNodeCount : 0;
    }
    ...
    {
      [DebuggerNonUserCode] get => this._isUnique;
      [DebuggerNonUserCode] set => this._isUnique = value;
    }
    ...
    public abstract class RBNodeBase : IIndexNode
    {
      ...
      {
        [DebuggerNonUserCode] get => this._tree;
      }

      public RBTreeBase<TKey, TValue, TNode>.NodeValues Values
      {
        [DebuggerNonUserCode] get => this._values;
      }
      ...
      {
        [DebuggerNonUserCode] get => this._branchNodeCount;
        [DebuggerNonUserCode] set => this._branchNodeCount = value;
      }

      public int BranchValueCount
      {
        [DebuggerNonUserCode] get => this._branchValueCount;
        [DebuggerNonUserCode] set => this._branchValueCount = value;
      }
      ...
      internal TNode Left
      {
        [DebuggerNonUserCode] get => this._left;
        [DebuggerNonUserCode] set => this._left = value;
      }

      protected internal TNode Right
      {
        [DebuggerNonUserCode] get => this._right;
        [DebuggerNonUserCode] set => this._right = value;
      }
      ...
      {
        [DebuggerNonUserCode] get => (Array) this.Tree.GetValues((TNode) this, (List<TValue>) null).ToArray();
      }
    }
    ...
    public class NodeValues : ICollection, IEnumerable
    {
      ...
      public int Count
      {
        [DebuggerNonUserCode] get => this._count + this._nullValues;
      }

      public RBTreeBase<TKey, TValue, TNode>.NodeValuesMode Mode
      {
        [DebuggerNonUserCode] get => this._mode;
      }
      ...
      {
        [DebuggerNonUserCode] get => throw new Exception("The method or operation is not implemented.");
      }
      ...
      IEnumerator
    {
      ...
      {
        [DebuggerNonUserCode] get => this._reseted ? default (TNode) : this._current;
      }

      public TKey Key
      {
        [DebuggerNonUserCode] get => this.Current.Key;
      }

      public TValue[] Values
      {
        [DebuggerNonUserCode] get => this._tree.GetValues(this.Current, (List<TValue>) null).ToArray();
      }
      ...
      {
        [DebuggerNonUserCode] get => (RBTreeBase<TKey, TValue, TNode>.RBNodeBase) this.Current;
      }
