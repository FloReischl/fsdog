...
namespace FR.Commands {
    public abstract class CommandBase : LoggingProvider, ICommand {
        ...
        public override LoggingManager Logger {
            [DebuggerNonUserCode]
            get => base.Logger == null && ApplicationBase.Instance != null ? ApplicationBase.Instance.Logger : base.Logger;
            [DebuggerNonUserCode]
        ...
        CommandInstanceState ICommand.InstanceState {
            [DebuggerNonUserCode]
            get => this.IntanceState;
            [DebuggerNonUserCode]
            set => this.IntanceState = value;
        }
