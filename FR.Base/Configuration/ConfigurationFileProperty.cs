...
namespace FR.Configuration
{
  ...
  public class ConfigurationFileProperty : IConfigurationProperty, IConvertible
  {
    ...
    {
      [DebuggerNonUserCode] get => this._configurationSource;
      [DebuggerNonUserCode] set => this._configurationSource = value;
    }
    ...
    public Hashtable ToHashtable(bool bFallbackToString)
    {
      ...
      foreach (XmlElement eItem in xmlNodeList)
      {
        object oKey;
        object oValue;
        this._getKeyValuePair(eItem, out oKey, out oValue, bFallbackToString);
        hashtable.Add(oKey, oValue);
      }
      return hashtable;
    }
