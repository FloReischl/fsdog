...
namespace FR.Configuration
{
  public class CommandLineArgs : List<CommandLineArg>
  {
    ...
    public NameValueCollection pnvArguments => this._arguments;

    public CommandLineArgs() => this._arguments = new NameValueCollection();
    ...
    protected virtual void Parse()
    {
      ...
      foreach (string originalArgument in this._originalArguments)
      {
        ...
        this._arguments.Add(commandLineArg.Argument, commandLineArg.Value);
      }
    }
