...
// Type: FR.Windows.Forms.DataGridViewComboBoxGetDisplayValueHandler
...
{
  public delegate void DataGridViewComboBoxGetDisplayValueHandler(
    object sender,
    CDataGridViewComboBoxGetDisplayValueArgs e);
}
