...
// Type: FR.Windows.Forms.Commands.CommandFileNewBase
...
{
  public class CommandFileNewBase : StandardCommandBase
  {
    public CommandFileNewBase() => this.ForceAlternateExecution = true;
  }
}
