...
// Type: FR.Windows.Forms.Commands.CommandEditUndoBase
...
{
  public class CommandEditUndoBase : StandardCommandBase
  {
    public CommandEditUndoBase() => this.ForceAlternateExecution = true;
  }
}
