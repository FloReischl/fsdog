...
// Type: FR.Windows.Forms.Commands.CommandFileSaveBase
...
{
  public class CommandFileSaveBase : StandardCommandBase
  {
    public CommandFileSaveBase() => this.ForceAlternateExecution = true;
  }
}
