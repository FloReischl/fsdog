...
// Type: FR.Windows.Forms.Commands.CommandEditRedoBase
...
{
  public class CommandEditRedoBase : StandardCommandBase
  {
    public CommandEditRedoBase() => this.ForceAlternateExecution = true;
  }
}
