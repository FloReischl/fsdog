...
// Type: FR.Windows.Forms.Commands.CommandFilePrintBase
...
{
  public class CommandFilePrintBase : StandardCommandBase
  {
    public CommandFilePrintBase() => this.ForceAlternateExecution = true;
  }
}
