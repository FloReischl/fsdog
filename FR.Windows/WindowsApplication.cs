...
namespace FR.Windows.Forms
{
  public abstract class WindowsApplication : ApplicationBase
  {
    ...
    {
      [DebuggerNonUserCode] get => (WindowsApplication) ApplicationBase.Instance;
    }

    public Form MainForm
    {
      [DebuggerNonUserCode] get => this._mainForm;
    }
    ...
    public EmbeddedResourceManager EmbeddedResourceManager
    {
      ...
      [DebuggerNonUserCode] set => this._embeddedResourceManager = value;
    }
