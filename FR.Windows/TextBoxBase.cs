...
namespace FR.Windows.Forms
{
  public class TextBoxBase : TextBox
  {
    ...
    {
      [DebuggerNonUserCode] get => this._validationType;
      set
      {
        this._validationType = value;
        if (this.validateType())
          return;
        if (!BaseHelper.InList((object) value, (object) TextBoxValidationType.Double, (object) TextBoxValidationType.Float, (object) TextBoxValidationType.Int, (object) TextBoxValidationType.Short))
          return;
        this.Text = "0";
      }
    }
    ...
    {
      [DebuggerNonUserCode] get => this._validateOnChange;
      [DebuggerNonUserCode] set => this._validateOnChange = value;
    }
